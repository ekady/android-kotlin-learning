...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val dataSource = SleepDatabase.getDatabase(this.requireContext()).sleepDatabaseDao

        val viewModelFactory = arguments?.let {
            SleepQualityViewModelFactory(it.sleepNightKey, dataSource)
        }

        val viewModel = viewModelFactory?.let { ViewModelProvider(this, it) }
