...
class ForageableViewModel(private val forageableDao: ForageableDao) : ViewModel() {
    ...
    val foragables = forageableDao.getForagables().asLiveData()

    fun getForagable(id: Long): LiveData<Forageable> {
        return forageableDao.getForagable(id).asLiveData()
    }
...
class ForagableViewModelFactory(private val forageableDao: ForageableDao): ViewModelProvider.Factory {
