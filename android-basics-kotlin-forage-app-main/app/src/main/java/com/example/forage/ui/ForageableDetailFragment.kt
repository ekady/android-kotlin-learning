...
import com.example.forage.ui.viewmodel.ForagableViewModelFactory
...
class ForageableDetailFragment : Fragment() {
    ...
    private val viewModel: ForageableViewModel by activityViewModels {
        ForagableViewModelFactory((activity?.application as BaseApplication).database.forageableDao())
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getForagable(id).observe(viewLifecycleOwner) {
            forageable = it
            bindForageable()
        }
    }
