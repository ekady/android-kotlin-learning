...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val selected: Map<Int, Int> = when (lemonadeState) {
            SQUEEZE -> mapOf(R.string.lemon_squeeze to  R.drawable.lemon_squeeze)
            DRINK -> mapOf(R.string.lemon_drink to R.drawable.lemon_drink)
            RESTART -> mapOf(R.string.lemon_empty_glass to R.drawable.lemon_restart)
            else -> mapOf(R.string.lemon_select to R.drawable.lemon_tree)
        }

        textAction.setText(selected.keys.elementAt(0))
        lemonImage.setImageResource(selected.values.elementAt(0))
    }
